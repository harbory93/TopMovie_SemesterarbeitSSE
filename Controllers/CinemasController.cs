...
namespace TopMovie_SemesterarbeitSSE.Controllers
{
    public class CinemasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,City,ImagePath")] Cinema cinema)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,City,ImagePath")] Cinema cinema)
        {
            if (id != cinema.Id)
            {
                return NotFound();
